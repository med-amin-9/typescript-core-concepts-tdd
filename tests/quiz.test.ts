...
test("q1_1", () => {
    expect(quiz.q1_1()).answer('?');
})
test("q1_2", () => {
    expect(quiz.q1_2()).answer('?');
})
test("q1_3", () => {
    expect(quiz.q1_3()).answer('?');
})

test("q2_1", () => {
    expect(quiz.q2_1()).answer('?');
})
test("q2_2", () => {
    expect(quiz.q2_2()).answer('?');
})
test("q2_3", () => {
    expect(quiz.q2_3()).answer('?');
})

test("q3_1", () => {
    expect(quiz.q3_1()).answer('?');
})
test("q3_2", () => {
    expect(quiz.q3_2()).answer('?');
})
test("q3_3", () => {
    expect(quiz.q3_3()).answer('?');
})

test("q4_1", () => {
    expect(quiz.q4_1()).answer('?');
})
test("q4_2", () => {
    expect(quiz.q4_2()).answer('?');
})

test("q5_1", () => {
    expect(quiz.q5_1()).answer('?');
})
test("q5_2", () => {
...
test("q8_1", () => {
    expect(quiz.q8_1()).answer('?');
})
test("q8_2", () => {
    expect(quiz.q8_2()).answer('?');
})
test("q8_3", () => {
    expect(quiz.q8_3()).answer('?');
})
test("q8_4", () => {
    expect(quiz.q8_4()).answer('?');
})

test("q9_1", () => {
    expect(quiz.q9_1()).answer('?');
})
test("q9_2", () => {
    expect(quiz.q9_2()).answer('?');
})
test("q9_3", () => {
    expect(quiz.q9_3()).answer('?');
})
test("q9_4", () => {
    expect(quiz.q9_4()).answer('?');
})